 ...
 *   3. Anything else: node's own resolution. The frontend sources depend on no
 *      library beyond the two stubbed above - the elements are plain custom
 *      elements - so there is nothing else to model.
 *
