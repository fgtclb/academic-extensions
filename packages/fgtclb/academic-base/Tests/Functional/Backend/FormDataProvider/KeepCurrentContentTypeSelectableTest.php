 ...
 *
 * `TcaDatabaseRecord` comes from `GeneralUtility::makeInstance()`: on TYPO3 v12 it is
 * not a public container service.
 *
...
final class KeepCurrentContentTypeSelectableTest extends AbstractAcademicBaseTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // What a component's page TSconfig does for its own content types.
        $connection->update(
            'pages',
