...
that does not include the page TSconfig entry of the component, a page tree
that uses a different site set, or a page that restricts the content types with
:typoscript:`TCEFORM.tt_content.CType.keepItems` or
