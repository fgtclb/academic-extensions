 ...
 */
abstract class AbstractDeliveryTestCase extends AbstractAcademicBiteJobsTestCase
{
    ...
    protected const AGGREGATE_SET = 'fgtclb/academic-bite-jobs';
    protected const COMPONENT_SET = 'fgtclb/academic-bite-jobs-list';
     ...
     */
    protected function setUpSite(array $dependencies = [], string $includeStaticFile = ''): void
    {
