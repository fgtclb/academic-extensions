 ...
 * this extension renders, on every supported core version: a label comes from
 * `locallang.xlf`, an override of the extension (`plugin.tx_academicbitejobs`) replaces it,
 * and an override of the plugin (`plugin.tx_academicbitejobs_list`) replaces both.
 *
 * Up to TYPO3 v13 the core builds the TypoScript path from the extension name a translation
 * passes, only lowercased, so a name with underscores read `plugin.tx_academic_bite_jobs`
