...
{
    public function saveRefererToSession(?ServerRequestInterface $request = null): void
    {
     ...
     * @return mixed
     */
    public function loadRefererFromSession(?ServerRequestInterface $request = null)
    {
