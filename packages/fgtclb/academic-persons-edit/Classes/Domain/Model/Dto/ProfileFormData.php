...
class ProfileFormData extends AbstractFormData
{
    ...
    public static function createFromProfile(Profile $profile): self
    {
        return new self(
            ...
            $profile->getLastName(),
            $profile->getGender(),
            $profile->getPublicationsLink(),
            $profile->getPublicationsLinkTitle(),
            $profile->getWebsite(),
            $profile->getWebsiteTitle(),
            $profile->getCoreCompetences(),
            $profile->getMiscellaneous(),
            $profile->getSupervisedDoctoralThesis(),
            $profile->getSupervisedThesis(),
            $profile->getTeachingArea()
        );
    }
