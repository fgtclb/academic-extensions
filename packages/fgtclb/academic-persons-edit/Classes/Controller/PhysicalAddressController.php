...
use FGTCLB\AcademicPersonsEdit\Domain\Validator\UpdatePhysicalAddressValidator;
...
final class PhysicalAddressController extends AbstractActionController
{
    ...
    {
        $addressFactory = GeneralUtility::makeInstance(AddressFactory::class);
        $physicalAddress = $addressFactory->get($addressFormData);
        $physicalAddress->setContract($contract);
    ...
    #[Validate([
        ...
        'validator' => UpdatePhysicalAddressValidator::class,
    ])]
    public function updateAction(Address $physicalAddress): ResponseInterface
    {
        $this->addressRepository->update($physicalAddress);
