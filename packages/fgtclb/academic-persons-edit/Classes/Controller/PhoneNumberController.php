...
final class PhoneNumberController extends AbstractActionController
{
    ...
    public function injectPhoneNumberFactory(PhoneNumberFactory $phoneNumberFactory)
    {
    ...
    public function newAction(Contract $contract, ?PhoneNumberFormData $phoneNumberFormData = null): ResponseInterface
    {
        $this->view->assignMultiple([
            'profile' => $contract->getProfile(),
            'contract' => $contract,
            'phoneNumberFormData' => $phoneNumberFormData ?? PhoneNumberFormData::createEmpty(),
    ...
    {
        $phoneNumber = $this->phoneNumberFactory->createFromFormData($phoneNumberFormData);
