...
{
    private EmailFactory $emailAddressFactory;
    public function injectEmailFactory(EmailFactory $emailAddressFactory): void
    {
        $this->emailAddressFactory = $emailAddressFactory;
    }

    private EmailRepository $emailAddressRepository;
    public function injectEmailRepository(EmailRepository $emailAddressRepository): void
    {
    ...
    public function newAction(Contract $contract, ?EmailFormData $emailAddressFormData = null): ResponseInterface
    {
        $this->view->assignMultiple([
            'profile' => $contract->getProfile(),
            'contract' => $contract,
            'emailAddressFormData' => $emailAddressFormData ?? EmailFormData::createEmpty(),
