..  _breaking-vue-profile-editing-views:

===================================================
Breaking: Profile editing views are rendered by Vue
====================================================

Description
===========

The profile editing frontend is now a Vue 3 Composition API application. Its
source lives below
...
margin above the restored preview. Contracts retain a separate reactive
document kind and use their dedicated Contract editor, including the configured
contact sections.
...
Template overrides of the former 2.x controller views no longer apply. The
profile editor is now composed from
``Resources/Private/Templates/Profile/{List,Index}.html`` and the partials
below ``Resources/Private/Partials/Profile``. JavaScript overrides of the
generated files are overwritten by the frontend build.

Affected installations
======================

Installations with Fluid overrides for the former frontend-editing views or
with custom JavaScript based on their Bootstrap modal hooks.
...
Render ``Profile/Documents/Editor`` and ``Profile/Image/Editor``
