..  _feature-inline-structured-section-crud:

=================================================
Feature: Inline structured-section CRUD over AJAX
=================================================
...
The workflows stay inside ``InlineProfileController``. The JSON actions
...
only through that user's profile and the requested section. They do not route
to the retained legacy controllers.
