...
page configured through ``plugin.tx_academicpersons.detailPid``. Importing the
shipped Detail route enhancer can turn that link into a speaking URI.
...
:file:`EXT:academic_persons/Configuration/Routes/Detail.yaml` for speaking URIs.
