..  _feature-inline-contract-contact-management:

===========================================
Feature: Inline Contract contact management
===========================================

Description
===========

Employee Contracts in the Vue inline profile editor are writable again and
...
The retained legacy contact controllers are not used.

Impact
======

InlineProfile template overrides must retain the
