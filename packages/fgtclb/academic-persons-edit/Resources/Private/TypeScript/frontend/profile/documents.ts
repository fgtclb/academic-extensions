 ...
 *
 * A deep reactive proxy would re-render whenever one of its properties was
 * written, including a property nested two levels down. Lit does not have that
 * and does not need it: the element below updates when a *property of the
 * element* is
