...
final class ProfileFormDataValidatorTest extends UnitTestCase
{
    ...
    public static function configuredProperties(): array
    {
        return [
            ...
            'emailAddress' => ['emailAddress', 'string(profile@example.org)'],
            'publishEmailAddress' => ['publishEmailAddress', 'bool(true)'],
            'phoneNumber' => ['phoneNumber', 'string(+49 123 456)'],
            'publishPhoneNumber' => ['publishPhoneNumber', 'bool(false)'],
