...
final class AcademicPersonsEditProfileEditingTest extends AbstractFrontendProfilePluginTestCase
{
    ...
    private function getProfileEditingJavaScriptSources(): string
    {
        $paths = [
    ...
    {
        $module = $this->getProfileEditingJavaScriptSources();
    ...
    public function frontendModuleExposesScopedInlineEditingContracts(): void
    {
        ...
        $this->assertStringNotContainsString('data-ie-cancel-all', $fluidSources);
        $this->assertStringNotContainsString('Profile/Profile/FooterActions', $fluidSources);
        $this->assertStringContainsString('data-user="{profile.uid}"', $template);
        $this->assertStringContainsString('partial="Profile/Image/Editor"', $template);
        $this->assertStringContainsString('partial="Profile/Documents/Editor"', $template);
        $this->assertStringContainsString(
        ...
        $this->assertStringNotContainsString('partial="Profile/Image/Modal"', $template);
        $this->assertStringNotContainsString('partial="Profile/Documents/Modal"', $template);
        $this->assertStringContainsString('partial="Profile/Header"', $template);
        $this->assertStringContainsString('partial="Profile/Profile/Personal"', $template);
        $this->assertStringContainsString('partial="Profile/Profile/About"', $template);
    ...
    public function profileEditorLabelsAreShippedInBothLanguages(): void
    {
        $expectedEnglish = [
            ...
            'profileEditing.documents.year' => 'Date',
        ...
        $this->assertSame('Datum', $germanTranslations['profileEditing.documents.year']);
