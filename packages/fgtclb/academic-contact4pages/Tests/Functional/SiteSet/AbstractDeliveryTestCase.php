 ...
 */
abstract class AbstractDeliveryTestCase extends AbstractAcademicContacts4PagesTestCase
{
    ...
    protected const AGGREGATE_SET = 'fgtclb/academic-contacts4pages';
    protected const COMPONENT_SET = 'fgtclb/academic-contacts4pages-list';
