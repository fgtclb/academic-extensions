...
namespace FGTCLB\AcademicContacts4pages\Tests\Functional\Core13\SiteSet;

use FGTCLB\AcademicContacts4pages\Tests\Functional\SiteSet\AbstractDeliveryTestCase;
...
final class SiteSetDeliveryTest extends AbstractDeliveryTestCase
{
    ...
    public function theConstantOfAcademicPersonsIsResolvedOnTheSiteSetPath(): void
    {
        ...
        $this->assertStringNotContainsString(
            ...
            $body,
            'The constant of "academic_persons" was not substituted, so the set did not deliver its TypoScript.',
        );
    }
