...
namespace FGTCLB\AcademicPartners\Tests\Functional\SiteSet;
 ...
 * four content elements share one `plugin.tx_academicpartners` block, so a component
 ...
 */
final class SiteSetDeliveryTest extends AbstractAcademicPartnersTestCase
{
    ...
    private const AGGREGATE_SET = 'fgtclb/academic-partners';
    private const CONTENT_LOAD_SET = 'fgtclb/academic-partners-content-load';

    /**
     * The constant the probe renders, assigned by
     * `Configuration/TypoScript/constants.typoscript` and by nothing else.
     */
    private const SHARED_CONSTANT = '<div id="constant">EXT:academic_partners/Resources/Private/Partials/</div>';

    /**
     * A value the probe copies out of the setup of the shared block, assigned by
     * `Configuration/TypoScript/setup.typoscript`.
     */
    private const SHARED_SETUP = '<div id="setup">EXT:academic_partners/Resources/Private/Templates/</div>';
    ...
    {
        $this->setUpSite(includeStaticFile: 'EXT:academic_partners/Configuration/TypoScript/Full');
    ...
    {
        $this->setUpSite(includeStaticFile: 'EXT:academic_partners/Configuration/TypoScript/');
    ...
    public static function contentLoadDataProvider(): \Generator
    {
        ...
        yield 'component set alone' => [['fgtclb/academic-partners-list'], false];
     ...
     * all four would pass every other assertion here.
     */
    #[Test]
    #[DataProvider('componentDataProvider')]
    ...
    private function setUpSite(array $dependencies = [], string $includeStaticFile = ''): void
    {
        ...
        $this->getConnectionPool()->getConnectionForTable('sys_template')->insert(
            ...
            [
                ...
                'title' => 'Probe',
                'constants' => '',
                'config' => '@import \'EXT:academic_partners/Tests/Functional/SiteSet/Fixtures/TypoScript/Probe.typoscript\'',
