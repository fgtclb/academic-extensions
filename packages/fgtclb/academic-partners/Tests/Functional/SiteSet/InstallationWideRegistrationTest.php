 ...
 * :sql:`pages` records. A page carrying doktype 40 or `pagets__AcademicPartner` exists
 ...
 */
final class InstallationWideRegistrationTest extends AbstractAcademicPartnersTestCase
{
    ...
    public function pageTypeIsRegisteredWithoutASiteSet(): void
    {
        ...
        $this->assertContains('40', $values, 'The page type of this extension is not selectable.');
        $this->assertSame(
            'tx-academicpartners-doktype-partner',
            $GLOBALS['TCA']['pages']['ctrl']['typeicon_classes'][40] ?? null,
