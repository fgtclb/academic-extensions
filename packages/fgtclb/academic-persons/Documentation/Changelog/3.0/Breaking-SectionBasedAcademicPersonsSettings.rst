...
..  list-table::
    ...
    *   -   :php:`AcademicPersonsSettings::getValidationSet()`,
        ...
        -   :php:`getProfileValidationSet()`,
            ...
            :php:`getContractContactValidationSet()`,
            :php:`getDocumentValidationSet()` and their ``ForFields``
            variants - every one of them returns an empty set for an
            unknown identifier, there is no separate fallback method
