...
final class MigrateProfileInformationDatesUpgradeWizard implements UpgradeWizardInterface
{
    ...
    {
        $columnPairs = $this->availableColumnPairs();
        if ($columnPairs === []) {
            return false;
        }
     ...
     */
    private function availableColumnPairs(): array
    {
