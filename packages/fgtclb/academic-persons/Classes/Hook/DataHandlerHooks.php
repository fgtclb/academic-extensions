...
final class DataHandlerHooks
{
    ...
    public function processDatamap_afterDatabaseOperations(
        ...
        // @todo A save that replaces the image without touching a name column
        //       leaves the new reference without the composed metadata. Adding
        //       the image column here changes what an import of the development
        //       seed writes, so it needs the committed snapshots and manifests
        //       rebuilt from a real instance import and is a change of its own.
