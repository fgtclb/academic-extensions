...
|---------------------|--------------------|---------------------------------------|
| `cgl`               | —                  | PHP 8.1, v12                          |
| `phpstan`           | —                  | v12/8.1, v13/8.2                      |
| `lint`              | —                  | PHP 8.1, 8.2, 8.3, 8.4, 8.5           |
| `unit`              | cgl, phpstan, lint | v12/8.1, v12/8.4, v13/8.2, v13/8.5    |
| `functional-sqlite` | unit               | the same four pairs                   |
| `functional-dbms`   | functional-sqlite  | the same four pairs × 4 DBMS, 16 jobs |
