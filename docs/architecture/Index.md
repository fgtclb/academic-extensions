...
| [List filter types](list-filter-types.md)                       | Which category filters a list offers, in which order and how many right away, options without results, the per-type "All" label and `_LOCAL_LANG` on v13 and v14, and the program finder.  |
