...
| [Profile editing contract](profile-editing-contract.md)       | The `data-*` attributes the profile editor is configured with, the reader that parses them once, and the two rules that look like details.            |
