...
| [Content element rendering](architecture/content-element-rendering.md)       | The two rendering shapes, what the `Default` layout renders, and why a content element template needs it.                                     |
