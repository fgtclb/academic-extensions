...
| [Upgrade checks](architecture/upgrade-checks.md)                             | The `academic:upgrade:check` command, and how it tells a project override folder from a folder the extensions ship themselves.                |
