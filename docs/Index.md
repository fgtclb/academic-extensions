...
| [Frontend verification for `academic-persons-edit`](testing/academic-persons-edit-frontend-tests.md) | The gates the profile editing TypeScript passes, and the behavioural coverage it does not have.              |
