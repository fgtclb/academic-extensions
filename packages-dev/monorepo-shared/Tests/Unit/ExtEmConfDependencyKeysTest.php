 ...
 * does not exist, and nothing else reports it: Composer installations read
...
final class ExtEmConfDependencyKeysTest extends TestCase
{
     ...
     *
     * `fgtclb/page-backend-layout` is only suggested, and nothing in the development setup
     * requires it. An entry here is accepted only where the extension's `composer.json`
     * names the package in the same kind of constraint, and fails once the package is
     * installed.
     */
