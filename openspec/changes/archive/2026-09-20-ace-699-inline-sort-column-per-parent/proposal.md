...
- TYPO3 v12 and v13 alike; the relation handling does not differ between them.
...
**This is the backport of the `main` change of the same name**, archived there
as `openspec/changes/archive/2026-09-20-ace-699-inline-sort-column-per-parent`.
It is re-derived from the backport analysis rather than cherry-picked; what had
to be adapted for TYPO3 v12 and PHP 8.1 is recorded in `design.md`, *Context*.
...
adopted into the same pipeline. Tracked as **ACE-699**, one issue for both
version lines. Relates to ACE-491 and ACE-431.
