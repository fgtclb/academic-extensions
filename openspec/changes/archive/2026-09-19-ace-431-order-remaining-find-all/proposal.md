...
- TYPO3 v12 and v13 alike; nothing differs between them.
- A backport of the `main` change archived there as
  `2026-09-19-ace-431-order-remaining-find-all`; the touched repository
  methods and the test assertions are identical on both branches, the test
  docblocks differ where the databases behave differently.
