...
- [x] 1.1 Extend the fixture of `AcademicPartnerPageTemplateTest` with one
...
- [x] 1.2 Do the same for `AcademicProjectPageTemplateTest` on the doktype 30
...
- [x] 3.1 Add `Documentation/Changelog/3.0/Important-PartnerPageRendersCategories.rst`
...
- [x] 3.2 Check `docs/` for statements about the page templates and update
...
- [x] 6.4 `docs/` and both extensions' `Documentation/` changelog updated in
  the same change.
