# academic-contact4pages/plugin-content-element-header Specification

## Purpose
Defines who renders the header of the plugins of `academic_contacts4pages`,
and how often it appears.

## Requirements

### Requirement: The plugin header renders once by default
Without configuration, the contacts list content elements SHALL NOT render a
...
An integrator SHALL be able to switch on, per site, that the contacts list
