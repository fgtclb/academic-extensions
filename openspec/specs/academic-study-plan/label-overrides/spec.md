# academic-study-plan/label-overrides Specification
...
TYPO3 v13 and v14 alike. The element is not a plugin, so no path of a plugin
applies to it.

#### Scenario: Label set for the extension on TYPO3 v13

- **WHEN** a site on TYPO3 v13 sets the label of the credit points under
  `plugin.tx_academicstudyplan._LOCAL_LANG`
- **THEN** the study plan shows that label, as on TYPO3 v14
...
- **WHEN** a site on TYPO3 v13 sets the label of the credit points only under
