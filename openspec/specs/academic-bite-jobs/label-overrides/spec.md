...
SHALL apply on TYPO3 v12 and v13 alike.
...
- **THEN** the b-ite job list shows that label

#### Scenario: Label set for one plugin

- **WHEN** a site sets the message shown without jobs under
  `plugin.tx_academicbitejobs_list._LOCAL_LANG`
- **THEN** the b-ite job list shows that label on TYPO3 v12 and v13
...
- **WHEN** a site sets the message shown without jobs only under
