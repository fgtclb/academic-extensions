# academic-base/hidden-content-type-preservation Specification
...
this page)". This applies on TYPO3 v12 and v13.

#### Scenario: Editor opens a profile list on a page without the persons component
- **WHEN** an editor opens an existing "Profile list" content element on a
  page where the academic_persons component is not enabled
...
different type. This applies on TYPO3 v12 and v13.

#### Scenario: New content element on a page without the component
...
hides that type. This applies on TYPO3 v12 and v13.
