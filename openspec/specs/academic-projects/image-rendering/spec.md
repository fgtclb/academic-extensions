# academic-projects/image-rendering Specification
...
#### Scenario: Project page of a site whose page object is a PAGEVIEW
- **WHEN** a visitor opens a project page with an image on a site whose page
