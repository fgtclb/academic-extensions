# academic-projects/page-module-category-summary Specification
...
The page module SHALL show, above the content grid of a project page, one entry
per category type of the `projects` group with the titles of the categories
assigned to that page. This SHALL hold on TYPO3 v12 and v13.

#### Scenario: Project page with categories

- **WHEN** an editor opens a project page carrying the competence field "Energy" in the page module
