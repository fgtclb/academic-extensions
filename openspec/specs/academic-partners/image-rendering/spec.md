# academic-partners/image-rendering Specification
...
#### Scenario: Partner page of a site whose page object is a PAGEVIEW
- **WHEN** a visitor opens a partner page with an image on a site whose page
