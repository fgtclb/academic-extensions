# academic-partners/label-overrides Specification
...
- **THEN** the partner list shows that label, as on TYPO3 v14
...
- **THEN** the partner list shows that label on TYPO3 v13 and v14
...
site sets through `_LOCAL_LANG` under `plugin.tx_academicpartners`, on TYPO3 v13
...
- **WHEN** a site sets the "Address" label under
  `plugin.tx_academicpartners._LOCAL_LANG`
- **THEN** the partner page shows that label on TYPO3 v13 and v14
